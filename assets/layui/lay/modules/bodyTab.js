...
layui.define(["element", "jquery"], function(exports) {
	...
	Tab.prototype.render = function() {
		...
		var parms = {
			roleId : sessionStorage.getItem('roleIds') || ""
		}
		reqAjaxAsync('operations/resourceTreeOwned',JSON.stringify(parms)).then(function(res) {
			//显示左侧菜单
			if($(".navBar").html() == '') {
				var _this = this;
				$(".navBar").html(navBar(res)).height($(window).height() - 245);
